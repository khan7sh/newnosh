        ...
        <div>
          ...
          <div className="mt-8">
            ...
            <ul className="space-y-1 text-sm">
              <li><a href="#" className="hover:text-green transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="hover:text-green transition-colors">Terms of Service</a></li>
